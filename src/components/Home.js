    ...
    <section id='home' className='bg-slate-800 w-full h-screen pt-16 flex flex-col space-y-2 justify-center items-center'>
        ...
        <div className='flex flex-col'>
            ...
            <div className='mt-6 flex justify-center space-x-2'>
              <a href='#' alt='Mon profil Github' onClick={(e) => e.preventDefault(handleClick('github'))} className='mt-2 p-2 text-lg text-slate-200 hover:text-stone-400'><i className='fab fa-github' /></a>
              <a href='#' alt='Mon profil Linkedin' onClick={(e) => e.preventDefault(handleClick('linkedin'))} className='mt-2 p-2 text-lg text-slate-200 hover:text-sky-400'><i className='fab fa-linkedin' /></a>
              <a href='#' alt='Ma chaîne Twitch' onClick={(e) => e.preventDefault(handleClick('twitch'))} className='mt-2 p-2 text-lg text-slate-200 hover:text-purple-400'><i className='fab fa-twitch' /></a>
              <a href='#' alt='Mon compte Twitter' onClick={(e) => e.preventDefault(handleClick('twitter'))} className='mt-2 p-2 text-lg text-slate-200 hover:text-cyan-400'><i className='fab fa-twitter' /></a>
              <a href='#' alt='Mon email pro' onClick={(e) => e.preventDefault(handleClick('mail'))} className='mt-2 p-2 text-lg text-slate-200 hover:text-rose-400'><i className='fas fa-at' /></a>
            </div>
        </div>
    </section>
  )
